...
export default function MobileMenu() {
  ...
  return (
    <div className="flex md:hidden font-sans">
      ...
      <button
        ref={trigger}
        className={`group inline-flex h-8 w-8 p-1 items-center justify-center bg-transparent text-center text-gray-900 transition ${
      ...
      >
        ...
        <svg
          className="pointer-events-none h-full w-full fill-current"
          viewBox="0 0 16 16"
      ...
      <div ref={mobileNav}>
        <Transition
          ...
          as="nav"
          id="mobile-nav"
          className="absolute left-0 top-full z-20 w-full rounded-xl bg-slate-100 shadow-lg shadow-black/[0.03] before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(theme(colors.gray.100),theme(colors.gray.200))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]"
        ...
        >
          <ul className="p-2 text-sm">
            <li>
              <Link
                href="#features"
                className="flex rounded-lg px-2 py-1.5 text-gray-700 hover:bg-gray-100 font-sans font-medium "
